...
class BoardGameRoomController {
    async store(req, res) {
        ...
        const gameExists = await BoardGame.findByPk(req.body.game_id);
        ...
        const {id} = await BoardGameRoom.create({
    ...
    async show(req, res) {
        ...
        const room = await BoardGameRoom.findByPk(req.params.room);
...
export default new BoardGameRoomController();