...
import SunkGameRoom from '../models/SunkGameRoom';

class SunkGameRoomController {
    async store(req, res) {
        ...
        const gameExists = await SunkGame.findByPk(req.body.game_id);
        ...
        const {id} = await SunkGameRoom.create({
    ...
    async update(req, res) {
        ...
        const room = await SunkGameRoom.findByPk(req.body.room);
    ...
    async show(req, res) {
        ...
        const room = await SunkGameRoom.findByPk(req.params.room);
...
export default new SunkGameRoomController();