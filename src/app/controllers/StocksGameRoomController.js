...
import StocksGameRoom from '../models/StocksGameRoom';

class StocksGameRoomController {
    async store(req, res) {
        ...
        const gameExists = await StocksGame.findByPk(req.body.game_id);
        ...
        const {id} = await StocksGameRoom.create({
    ...
    async update(req, res) {
        ...
        const room = await StocksGameRoom.findByPk(req.body.room);
    ...
    async show(req, res) {
        ...
        const room = await StocksGameRoom.findByPk(req.params.room);
...
export default new StocksGameRoomController();