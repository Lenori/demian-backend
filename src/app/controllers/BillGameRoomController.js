...
import BillGameRoom from '../models/BillGameRoom';

class BillGameRoomController {
    async store(req, res) {
        ...
        const gameExists = await BillGame.findByPk(req.body.game_id);
        ...
        const {id} = await BillGameRoom.create({
    ...
    async update(req, res) {
        ...
        const room = await BillGameRoom.findByPk(req.body.room);
    ...
    async show(req, res) {
        ...
        const room = await BillGameRoom.findByPk(req.params.room);
...
export default new BillGameRoomController();